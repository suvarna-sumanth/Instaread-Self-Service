...
const PlayerConfigSection = ({
  config,
  setConfig,
  analysis,
  disabled,
}: PlayerConfigSectionProps) => {
  ...
  return (
    ...
    >
      <CardHeader>
        ...
        <CardDescription>
          Customize the player's appearance and features.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setConfig((prev) => ({
                ...prev,
                playerType: value as PlayerType,
              }))
            }
            disabled={disabled}
          >
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Determines the player's main color.
          </p>
        </div>
      </CardContent>
    </Card>
